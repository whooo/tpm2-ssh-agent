% tpm2-ssh-agent(SECTION) | User Commands
%
% "May 31 2022"
...
tpm2-ssh-agent - program to do something

# SYNOPSIS

**tpm2-ssh-agent** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**tpm2-ssh-agent** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **tpm2-ssh-agent** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**tpm2-ssh-agent** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    tpm2-ssh-agent. See **foo.conf**(5) for further details.
...
**tpm2-ssh-agent** provides some return codes, that can be used in scripts:
